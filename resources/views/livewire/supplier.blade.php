                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button
                                                    ...
                                                    wire:click="deleteMessage({{$supplier}})"><i class="bi bi-trash"></i>
                                                </button>
                                                /
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button
                            @disabled(($type == 'debt' && ($payment == 'bank' && $debt_amount > $bankBalance))) @disabled(($type == 'debt' && ($payment == 'cash' && $debt_amount > $safeBalance))) @disabled(empty($currentSupplier) || $debt_amount == 0 || $due_date == '') class="btn btn-{{$debtId == 0 ? 'primary' : 'success'}} w-100"
