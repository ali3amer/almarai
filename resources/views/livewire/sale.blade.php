                        ...
                        <table class="table table-bordered text-center">
                            ...
                            @foreach($sales as $sale)
                                <tr>
                                    ...
                                    <td>{{ $sale->phone }}</td>
                                    <td>
                                        <button class="btn btn-sm btn-info text-white" wire:click="edit({{$sale}})">Edit</button> /
                                        <button class="btn btn-sm btn-danger" wire:click="delete({{$sale->id}})">delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
