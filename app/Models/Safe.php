...
class Safe extends Model
{
    ...
    public function getPastBalanceAttribute()
    {
        return $this->initialBalance
            ...
            - EmployeeGift::where("payment", "cash")->where("type", "salary")->where("due_date", "<", session("date"))->sum("amount")
            - EmployeeGift::where("payment", "cash")->where("type", "debt")->where("due_date", "<", session("date"))->sum("amount")
            + EmployeeGift::where("payment", "cash")->where("type", "pay")->where("due_date", "<", session("date"))->sum("amount")
    ...
    public function getCurrentBalanceAttribute()
    {
        return $this->initialBalance
            ...
            - EmployeeGift::where("payment", "cash")->where("type", "salary")->sum("amount")
            - EmployeeGift::where("payment", "cash")->where("type", "debt")->sum("amount")
            + EmployeeGift::where("payment", "cash")->where("type", "pay")->sum("amount")
    ...
    public function getPastSafeBalance($date)
    {
        ...
        return $initial
            ...
            - SaleDebt::where("type", "debt")->where("due_date", "<", $date)->where("payment", "cash")->sum("amount")
            + DepositDebt::where("type", "pay")->where("due_date", "<", $date)->where("payment", "cash")->sum("amount")
            - DepositDebt::where("type", "debt")->where("due_date", "<", $date)->where("payment", "cash")->sum("amount")
            + Transfer::where("transfer_type", "bank_to_cash")->where("due_date", "<", $date)->sum("amount")
            - Transfer::where("transfer_type", "cash_to_bank")->where("due_date", "<", $date)->sum("amount")
            ...
            - EmployeeGift::where("payment", "cash")->where("type", "debt")->where("due_date", "<", $date)->sum("amount")
            + EmployeeGift::where("payment", "cash")->where("type", "pay")->where("due_date", "<", $date)->sum("amount")
            - PurchaseDebt::where("type", "pay")->where("due_date", "<", $date)->where("payment", "cash")->sum("amount")
            + PurchaseDebt::where("type", "debt")->where("due_date", "<", $date)->where("payment", "cash")->sum("amount")
            - Withdraw::where("due_date", $date)->sum("amount")
            - SaleReturn::where("due_date", "<", $date)->sum("amount")
            + PurchaseReturn::where("due_date", "<", $date)->sum("amount");
    }
    ...
    public function getSafeBetweenBalance($from, $to)
    {
        ...
        return $safe
            ...
            - EmployeeGift::where("payment", "cash")->where("type", "salary")->whereBetween("due_date", [$from, $to])->sum("amount")
            - EmployeeGift::where("payment", "cash")->where("type", "debt")->whereBetween("due_date", [$from, $to])->sum("amount")
            + EmployeeGift::where("payment", "cash")->where("type", "pay")->whereBetween("due_date", [$from, $to])->sum("amount")
